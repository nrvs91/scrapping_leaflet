...
retailer = "stokrotka"
starting_url = 'https://stokrotka.pl/'
img_selector = '[data-image_main^="/data/domains/1/pl/w_prezentation/123/"][data-image_main$=".jpg"]'  # CSS selector to find elements with data-image_main attribute ending in .jpg  # CSS selector to find elements with data-image_main attribute
img_attribute = "data-image_main"   # Attribute name containing the image URL
